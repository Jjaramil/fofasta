...
function checkDonationAmount(elem){
  if($(elem).val() > 0 ){
    $(".disabled-overlay").removeClass("activate")
  }else{
    $(".disabled-overlay").addClass("activate")
  }
}
...
var gauge1 = Gauge(document.getElementById("gauge1"), {
  ...
  label: function(item, value) {
    ...
    tspan1.textContent="$"+Math.round(value * 100) / 100;
    tspan1.setAttribute('x',50);
    tspan1.setAttribute('y',40);
